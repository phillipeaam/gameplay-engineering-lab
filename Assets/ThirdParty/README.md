...
| RPG Monster Buddy PBR Polyart | Dungeon Mason | [Unity Asset Store](https://assetstore.unity.com/packages/p/rpg-monster-buddy-pbr-polyart-253961) | [Standard Unity Asset Store EULA](https://unity.com/legal/as-terms), Extension Asset |
| RPG Monster Duo PBR Polyart | Dungeon Mason | [Unity Asset Store](https://assetstore.unity.com/packages/3d/characters/creatures/rpg-monster-duo-pbr-polyart-157762) | [Standard Unity Asset Store EULA](https://unity.com/legal/as-terms), Extension Asset |
| RPG Tiny Fantasy Forest PBR | Dungeon Mason | [Unity Asset Store](https://assetstore.unity.com/packages/3d/environments/fantasy/rpg-tiny-fantasy-forest-pbr-309458) | [Standard Unity Asset Store EULA](https://unity.com/legal/as-terms), Extension Asset |
